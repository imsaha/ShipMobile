        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuccessNote = table.Column<string>(nullable: true),
                    FailedNote = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerId = table.Column<long>(nullable: false),
                    AddressId = table.Column<long>(nullable: false),
                    WeightInKg = table.Column<double>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipmentPackage", x => new { x.ShipmentId, x.PackageId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "057e773b-f5ad-4881-93be-372e0d4885c3", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { 2L, "57140f89-1ac3-4eb1-b283-decb8da80ebb", "DeliveryAssociate", "DELIVERYASSOCIATE" });
